...
L.textDesc = "Affiche ou non le texte sur les barres."
L.icon = "Icône"
...
L.disableSfxDesc = "L'option "Effets sonores" dans les options de son de WoW sera désactivée, puis réactivée à la fin du combat de boss. Cela peut vous permettre d'être plus attentif aux alertes sonores de BigWigs."
